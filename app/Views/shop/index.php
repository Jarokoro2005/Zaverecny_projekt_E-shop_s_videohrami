    ...
    <div class="shop-layout">
                ...
                <div class="sidebar__section">
                    ...
                    <div class="price-range">
                        <input
                            ...
                            name="max_price"
                            min="0"
                            max="<?= (int) $controller->getHighestPrice() ?>"
                            value="<?= Helpers::e((string) $filters['max_price']) ?>"
                            style="--val: <?= Helpers::pricePercent((float) $filters['max_price'], $controller->getHighestPrice()) ?>%"
                        >
        ...
        <main>
            <form class="shop-toolbar" method="get" action="shop.php">
                ...
                <p class="shop-toolbar__count">Showing <span><?= $controller->getTotalGames() ?></span> games</p>
